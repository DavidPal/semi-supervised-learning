...
the combinatorial structure of the function class (rather than just on the Vapnik-Chervonenkis dimension).

It remains an open problem to quantify the gap for other function
classes, such as halfspaces over $\R^n$, disjunctions, conjunctions, etc.
