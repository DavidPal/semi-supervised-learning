...
constant $\epsilon$ and $\delta$, the separation of labeled sample complexities
is at most a constant factor. These result suggest that unlabeled data are
useless. However, these settings ignore distributions with small cover and/or
dependency on the Vapnik-Chervonenkis dimension.
