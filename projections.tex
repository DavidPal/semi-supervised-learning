...
$$
Throughout this section, we treat $p$ as a constant that does not depend on $n$.
Theorems below we will place some further constraints on $p$. As we will see,
any $p \in (0,\frac{1}{16})$ works.
...
$$
m \le \frac{\ln n}{3 \ln (1/p)}
$$
labeled examples, it fails to $2p$-learn the target concept with probability
more than $\frac{1}{8} - 2p$.
\end{theorem}
...
We demonstrate the existence of a pair $(P,c) \in \P_{n,p} \times C_n$ which
...
\P_{n,p}$ and target $c_I \in C_n$. Let $X_1, X_2, \dots, X_m$ be an i.i.d.
